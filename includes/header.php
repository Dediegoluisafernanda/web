...
<div class="top-header">
	<div class="container">
		...
		<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 
			<li class="tol">Correo: ChocòExplora@gmail</li>	
			<li class="tol">Número: 3115865714</li>				
...
<div class="header">
	<div class="container">
		<div class="logo wow fadeInDown animated" data-wow-delay=".5s">
			<a href="index.php">Turismo <span style="font-size: 36px; font-weight: bold; font-family: 'Georgia', serif; color: #2a7b4f;">ChocóExplora</span>
			</a>	
		</div>
