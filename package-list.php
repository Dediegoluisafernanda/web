...
<html>
<head>
<title>ChocòExplora | Lista de paquetes</title>
...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Lista de paquetes</h1>
	</div>
</div>
<!--- /banner ---->
<!--- rooms ---->
