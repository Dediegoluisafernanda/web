...
<div class="banner">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">"ChocoExplora: Turismo sostenible que conecta naturaleza y cultura."</h1>
	</div>
</div>
	...
	<div class="rupes">
		...
		<div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
			...
			<div class="rup-rgt">
				...
				<h4><a href="offers.html">HOSPEDAJE EN CUALQUIER PARTE DEL CHOCÒ</a></h4>
		...
		<div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
			...
			<div class="rup-rgt">
				<h3>50% MENOS, SIN TRUCOS NI SORPRESAS</h3>
				<h4><a href="offers.html">OFERTA DE APLICACIÓN </a></h4>
